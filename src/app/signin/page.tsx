...
export default function Signin() {
  ...
  const { user, signInWithEmailAndPassword, signOut } = useAuth();
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              onClick={(e)=>{
                ...
                className="disabled:opacity-40 flex w-full justify-center rounded-md bg-indigo-500 px-3 py-1.5 text-sm font-semibold leading-6 text- shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
              >
                Sign in
              </button>
            </div>
